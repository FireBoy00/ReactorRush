...
namespace Rooms
{
    public class EmergencyBackupRoom : IRooms
    {
        ...
        private readonly int minigameIndex = 0; // Index of the minigame in the minigames list
